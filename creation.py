...
"""Compulsive Behavior.  You're driven to undertake a certain action.  This might be a tic, obsessive-compulsive behavior, a special kind of hunger (ie. a thirst for human bone marrow), a prerequisite for action (must demolish surroundings to make a bed for comfortable sleep, like a dog turns in circles before resting) or a desire to find a mate.  This isn't related to the power so much as the body, and core needs such as a need for shelter, a desire for sustenance or raw instinct.  (In short, tying into alien behavior from previous cycles).  You """,
